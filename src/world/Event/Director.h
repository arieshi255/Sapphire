...
namespace Sapphire::Event
{
  ...
  */
  ...
  public:
    ...
    void sendDirectorUpdate( Sapphire::Entity::Player& player, uint32_t param1, uint32_t param2 = 0, uint32_t param3 = 0,
                             uint32_t param4 = 0, uint32_t param5 = 0, uint32_t param6 = 0 ) const;
